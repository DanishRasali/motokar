...
class HostBookVehicleView extends StatefulWidget {
  const HostBookVehicleView({this.vehicle, this.vehicleProfile, this.vehicleRating});
  final Vehicle vehicle;
  final Profile vehicleProfile;
  final double vehicleRating;

  @override
  _HostBookVehicleViewState createState() => _HostBookVehicleViewState();
}

class _HostBookVehicleViewState extends State<HostBookVehicleView> {
