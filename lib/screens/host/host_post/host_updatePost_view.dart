...
class HostUpdatePostView extends StatefulWidget {
  const HostUpdatePostView({this.post});
  final Post post;

  @override
  _HostUpdatePostViewState createState() => _HostUpdatePostViewState();
}

class _HostUpdatePostViewState extends State<HostUpdatePostView> {
