...
import 'package:motokar/screens/host/host_trips/host_trip_view.dart';
import 'package:motokar/screens/shared/colors.dart';

class HostTripWidget extends StatelessWidget {
  final Trip trip;
  final Vehicle vehicle;
  final Profile vehicleProfile;
  final double vehicleRating;

  HostTripWidget({this.trip, this.vehicle, this.vehicleProfile, this.vehicleRating});
