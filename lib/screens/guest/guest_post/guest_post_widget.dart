...
import 'package:motokar/screens/guest/guest_explore/guest_bookVehicle_view.dart';
import 'package:motokar/screens/guest/guest_post/guest_updatePost_view.dart';
import 'package:motokar/screens/shared/colors.dart';
import 'package:motokar/screens/shared/topProfile.dart';

class GuestPostWidget extends StatelessWidget {
  final Post post;
  final Profile postProfile;
  final String profileId;

  GuestPostWidget({this.post, this.postProfile, this.profileId});
            ...
            onTap: () {
              if (profileId == postProfile.id) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => GuestUpdatePostView(post: post)));
              }
            },
            child: Column(
              children: [
