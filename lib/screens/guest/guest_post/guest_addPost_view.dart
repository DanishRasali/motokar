...
class GuestAddPostView extends StatefulWidget {
  const GuestAddPostView();

  @override
  _GuestAddPostViewState createState() => _GuestAddPostViewState();
}

class _GuestAddPostViewState extends State<GuestAddPostView> {
