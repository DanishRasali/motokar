...
class GuestVehicleWidget extends StatelessWidget {
  final Vehicle vehicle;
  final Profile vehicleProfile;
  final double vehicleRating;

  GuestVehicleWidget({this.vehicle, this.vehicleProfile, this.vehicleRating});
        ...
        child: InkWell(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => GuestBookVehicleView(
                          vehicle: vehicle, 
