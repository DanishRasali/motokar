...
class GuestTripView extends StatefulWidget {
  const GuestTripView({this.trip, this.vehicle, this.vehicleProfile, this.vehicleRating});
  final Trip trip;
  ...
  @override
  _GuestTripViewState createState() => _GuestTripViewState();
}

class _GuestTripViewState extends State<GuestTripView> {
