...
class GuestUpdateProfileView extends StatefulWidget {
  const GuestUpdateProfileView({this.profile});
  final Profile profile;

  @override
  _GuestUpdateProfileViewState createState() => _GuestUpdateProfileViewState();
}

class _GuestUpdateProfileViewState extends State<GuestUpdateProfileView> {
